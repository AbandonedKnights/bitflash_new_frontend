...
export default function ExSide(props) {
  ...
  return (
    ...
    >
      <Helmet>
        <link rel="icon" href="/null" id="favicon" />
        <title id="coin_value"></title>
      </Helmet>
      <div className="box-body px-0 pb-0">
                    ...
                    <>
                      <div
                        ...
                        onClick={function () {
                          ...
                          // if(item.currency_coin=="usdt"){

                          //   console.log(current_price_usdt,"usd price")
                          //   value_setter= current_price_usdt;

                          // }
                          // else if(item.currency_coin=="usdt"){
        ...
        >
          <table
            id="coins_table"
            className="table no-border no-margin tablesorter"
            style={{ height: "auto" }}
          >
            <thead>
              <tr>
...
function CoinRow(props) {
  ...
  let price = 0;
  // console.log("check symbol_1: ", props.current_price_inr, props.symbol, props.pc_price, props.pairing_currency);
  ...
  switch (props.pairing_currency.toUpperCase()) {
    case "INR":
      ...
      }).format(props.current_price_inr ? props.current_price_inr : 0.12);
    ...
    case "USDT":
      price = new Intl.NumberFormat("en-IN", {
        ...
        props.symbol == 'BTXX' || props.symbol == 'BTEX' ? props.current_price_usdt:(
        props.current_price_usdt &&
          props.current_price_usdt &&
          props.pairing_currency.toUpperCase() === "INR" > 0
          ? div(props.raw_current_price_inr, props.pc_price.USDT)
    ...
    case "BTC":
      price =
        props.current_price_btc && props.current_price_btc > 0
          ? props.current_price_btc
          : props.raw_current_price_inr
          ? div(props.raw_current_price_inr, props.pc_price.BTC)
          : 0.03;
      // console.log("check symbol_2: ", props.symbol, price);
      break;
    case "BTEX":
      price =
        props.current_price_vrx && props.current_price_vrx > 0
          ? props.current_price_vrx
          : props.raw_current_price_inr
          ? div(props.raw_current_price_inr, props.pc_price.BTEX)
          : 0.03;
      break;
    default:
      price = new Intl.NumberFormat("en-IN", {
  ...
  return (
    ...
    >
      <td
        colSpan="2"
        onClick={function () {
          if (props.direction_inr == "up") {
            var arrowSetter = "&#x2191";
          } else arrowSetter = "&#x2193;";

          var a = document.getElementById("coin_value");
        ...
        <div className="d-flex  justify-content-start align-items-center">
          ...
          <div className="p-1">
            <div className="mdfthemetxt">
              <strong style={{fontSize:"12px"}}>{props.symbol}</strong><span style={{fontSize:"10px"}}>/{props.pairing_currency?.toUpperCase()}</span>
            </div>
            <div className="no-wrap">
              ...
              >
                ...
                ></i>{" "}
                <strong>{props.price_change_percentage_1h_inr}%</strong>
              </span>
            </div>
          </div>
        </div>
